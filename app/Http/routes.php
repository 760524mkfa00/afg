...
//    Route::get('/projects/{year}', ['as' => 'projectsByYear', 'uses' => 'ProjectsController@projectsByYear']);
    Route::get('/projects/{q}', ['as' => 'projectsSearch', 'uses' => 'ProjectsController@projectsSearch']);
